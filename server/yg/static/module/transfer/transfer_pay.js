define("transfer/transfer_pay", ["ui/verifyInput/VerifyInput", "ui/modal/modal", 'ui/validation/validation', "common/config",], function (require, exports, module) {
        ...
        btnValid.on('click', function () {
            ...
            if (btnValid.hasClass("btn_disable")) {
                ...
                if ($("#bank").val()) {
                    ...
                    $("#transferPayForm").submit()//;productPayForm
                }
