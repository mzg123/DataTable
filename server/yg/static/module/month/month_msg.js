define("month/month_msg", ["ui/modal/modal", 'common/config', "ui/validation/validation",], function (require, exports, module) {
        ...
        $("#viewTemplate2").on("click", function () {
            ...
            var protocol="#viewProtocol2";
            if(planType=="300112")
                protocol="#viewProtocol2";
            else if(planType=="300224")
                protocol="#viewProtocol2_1";
            modal.show({
                title: $(protocol).attr("title"),
                content: $(protocol).html(),
                size: {width: 750, height: 600},
