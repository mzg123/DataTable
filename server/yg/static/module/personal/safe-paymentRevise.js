define("personal/safe-paymentRevise", ['ui/validation/validation', "ui/modal/modal","common/config"], function (require, exports, module) {
        var modal = require('ui/modal/modal');

        require('ui/validation/validation');
        var config = require('common/config');

        var VMCD = "ppwdrst_vmcd";
        ...
        exports.run = function () {
            ...
            $("#getMsg").on("click", function () {
                if ($(this).hasClass("btn_disable")) {
                    ...
                    $.ajax({
                        type: "post",
                        url: config.api.verifyCodeMsg + "/modifypaypwd",
                        // data: {},
                        dataType: "json",
