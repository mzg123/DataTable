define("personal/creditors-back-pay", ["ui/verifyInput/VerifyInput", "ui/modal/modal", 'ui/validation/validation', "common/config", ], function (require, exports, module) {
        ...
        btnValid.on('click', function () {
            ...
            if (btnValid.hasClass("btn_disable")) {
                ...
                if ($("#bank").val()) {
                    ...
                    //$("#productPayForm").submit();
                    doTransfer($("#productPayForm").data('validator').getFormData());
