define("product/product_pay", ["ui/verifyInput/VerifyInput", "ui/modal/modal", 'ui/validation/validation', "common/config", ], function (require, exports, module) {
    ...
    exports.run = function () {
        ...
        $("#getMsg").on("click", function () {
            ...
            if ($(this).hasClass("btn_disable")) {
                ...
                $.ajax({
                    type: "post",
                    url: config.api.verifyCodeMsg + "/paying",
                    //data: {},
                    dataType: "json",
